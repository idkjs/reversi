...
module Renderer = {
  ...
  [@bs.send.pipe: t]
  external containsAllMatchingElements: array(node) => bool =
    "containsAllMatchingElements";
  [@bs.send.pipe: t]
  external containsAnyMatchingElements: array(node) => bool =
  ...
  [@bs.send.pipe: t]
  external simulate3: (string, 'a, 'b, 'c) => unit = "simulate";
  [@bs.send.pipe: t]
  external simulate4: (string, 'a, 'b, 'c, 'd) => unit = "simulate";
  [@bs.splice] [@bs.send.pipe: t]
  ...
  [@bs.send.pipe: t]
  external foldRight: (('a, t) => 'a, 'a) => 'a = "reduceRight";
...
[@bs.module "@wojtekmaj/enzyme-adapter-react-17"] [@bs.new]
external react_17_adapter: unit => adapter = "default";

[@bs.module "enzyme"]
external configure: js_obj_with_adapter => adapter = "configure";

[@bs.module "enzyme-adapter-react-16"] [@bs.new]
external react_16_adapter: unit => adapter = "default";

[@bs.module "enzyme-adapter-react-15"] [@bs.new]
external react_15_adapter: unit => adapter = "default";

[@bs.module "enzyme-adapter-react-15.4"] [@bs.new]
external react_15_4_adapter: unit => adapter = "default";

[@bs.module "enzyme-adapter-react-14"] [@bs.new]
external react_14_adapter: unit => adapter = "default";

[@bs.module "enzyme-adapter-react-13"] [@bs.new]
external react_13_adapter: unit => adapter = "default";

[@bs.module "preact-enzyme-adapter"] [@bs.new]
external preact_adapter: unit => adapter = "default";

[@bs.module "enzyme-adapter-inferno"] [@bs.new]
external inferno_adapter: unit => adapter = "default";
